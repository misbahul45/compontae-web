...
const page = () => {
  ...
  const form = useForm<z.infer<UserRegisterType>>({
    mode: 'onChange',
  ...
  return (
    <section className='min-h-screen flex md:flex-row flex-col bg-gradient-to-r pt-12 from-cyan-500 to-green-500 pb-24'> 
      <div className='relative flex-1 px-4 flex flex-col justify-center items-center'>
        ...
        <p className='text-white text-xs text-center mt-8'>Dengan Registrasi Anda, Anda menyetujui ketentuan dan syarat-syarat yang berlaku</p>
      </div>  
