  ...
  return (
    <div className='py-24 bg-[url("/home-hero.jpg")] w-full md:h-screen px-2 bg-cover bg-no-repeat flex flex-col justify-center items-center relative'>
        ...
        <div className='flex items-center gap-2 z-10'>
            <h1
            className='text-center lg:text-7xl md:text-5xl sm:text-4xl text-2xl text-white font-bold md:mb-4 mb-2'>Compontae</h1>
        </div> 
        <h2 className='z-10 text-center lg:text-3xl md:text-2xl text-md text-white font-bold max-w-5xl mx-auto'>Mari kita jaga alam dengan tindakan nyata, mulai dari mengurangi sampah plastik hingga menanam pohon. Bumi adalah warisan kita, jangan biarkan ia terluka!</h2>
        <div className='z-10 flex gap-4 items-center mt-10'>
